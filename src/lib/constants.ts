...
export const VENUE_DETAILS = {
  ...
  features: [
    {
      title: "Capacity",
      desc: "Accommodates up to 3,000 guests comfortably",
    },
    {
      title: "24/7 Venue Access",
      desc: "Round-the-clock availability for seamless events",
    },
    {
      title: "Massive Parking",
      desc: "Dedicated secure space for 500+ vehicles",
    },
    {
      title: "Air Conditioned",
      desc: "Fully climate-controlled indoor halls",
    },
    {
