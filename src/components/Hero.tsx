...
export default function Hero({ onOpenBooking }: HeroProps) {
  ...
  return (
    <section id="home" className="relative min-h-screen flex flex-col justify-between">
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-6 md:px-12 w-full pt-[32vh] pb-[12vh] flex-1 flex flex-col justify-center">
        <motion.div
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl lg:text-[90px] font-serif font-bold text-white-soft leading-[1.05] tracking-tight mb-8">
            Where Every Celebration <br />
            <span className="text-gold-soft">Becomes A Lifetime Memory</span>
          </h1>

          <p className="text-lg md:text-xl text-muted-text font-sans font-light max-w-2xl mb-12 leading-relaxed">
            Wedding Venue in Warangal for unforgettable celebrations. Indulge in Aman-inspired architecture, grand banquet halls, and spectacular service design.
          </p>
      ...
      <div className="absolute bottom-[22vh] left-1/2 -translate-x-1/2 z-20 flex gap-3">
      ...
      {/* Below Hero: Premium Highlight Strip */}
